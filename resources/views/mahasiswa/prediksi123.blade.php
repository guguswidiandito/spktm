            ...
            <div class="widget big-stats-container">
                <div class="widget-content">
                    <div class="container-fluid">
                        {!! Form::open(['url' => '/admin/mahasiswa/prediksi/ipk/semester1-3/', 'method'=>'get', 'class'=>'form-inline']) !!}
...
<div class="span12">
    <div class="widget widget-nopad">
        <div class="widget-header">
            <h3>{!! Form::open(['url' => route('export.prediksi.semester1-3'),
            'method' => 'post']) !!}
